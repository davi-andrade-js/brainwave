      ...
      <div className="container">
        ...
        <div className="relative">
          <div
            ...
            rounded-3xl overflow-hidden lg:p-28 xl:h-[46rem]"
          >
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/05 xl:w-auto">
              <img
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              ...
              <div className="relative h-[20rem] bg-n-9 rounded-xl overflow-hidden md:h-[25rem]">
                <img
                  src={service3}
                  className="w-full h-full object-cover"
                  width={520}
