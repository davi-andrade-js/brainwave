  ...
  return (
    <div className="flex gap-[1rem] max-lg:flex-wrap">
      {pricing.map((item) => (
        <div
          key={item.id}
          className="w-[90rem] max-lg:w-full h-full px-6 bg-n-8 border border-n-6
        ...
        >
          ...
          <Button
            ...
            href={item.price ? "/pricing" : "mailto:placeholder@brainwave"}
            white={!!item.price}
          >
            {item.price ? "Começar" : "Entre em contato"}
          </Button>
